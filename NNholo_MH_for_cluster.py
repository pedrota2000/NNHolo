...
phim_param=[3.0,2.0,1.5,1.08,1.0] 
...
c = NNholo_multihead_heist(sofT_path_list=sofT_list, phim_list = phim_param,\
           ...
           V_head_arch=V_head, actv_V_head=nn.SiLU, u_sampling='chebyshev2-noisy', n_batches_train=1, metric_flat_coef=500, UR=True)#,load_path = load_path)
