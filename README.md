...
- Inside paper_2, there are two regimes: near-false-vacuum, and false vacuum.
    ...
    - For the near-false-vacuum regime ($\phi_M=0.8$), the code pipeline is defined in _NNholo_near_FV.py_ and executed in _train.py_. The training is performed similarly to the paper I models.
