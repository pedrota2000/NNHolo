...
parent_dir = os.path.dirname(os.path.abspath(__file__))+"/0_8/"
# Path 
...
for k in range(len(phim_param)):
    ...
    sofT_path = "/home/pablo/NNholo/Data/Potentials_phim/SofTphiM" + phim_str + ".txt"

    sofT_list.append(sofT_path)
    
contrastive_weights_path = os.path.dirname(os.path.abspath(__file__))+'/Pau_base_run_weights/weights_per_eq_and_interp_IR_sofT_norm_along_eqs_0_8_pau_base_run.npy'
...
for j in range(reps):
    ...
    c.save_results(f'{path_results}/NN_contrastive_w_loc_u_0_8_seed_2')
